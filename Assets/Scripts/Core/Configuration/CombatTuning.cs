...
namespace MakeMeHero.Core
{
    ...
    { public HeroStats(decimal hp, decimal attack, decimal attackInterval, SkillDefinition skill) { Hp = hp; Attack = attack; AttackInterval = attackInterval; Skill = skill; } public decimal Hp { get; private set; } public decimal Attack { get; private set; } public decimal AttackInterval { get; private set; } public SkillDefinition Skill { get; private set; } }
    public sealed class WolfStats
    { public WolfStats(decimal hp, decimal attack, decimal attackInterval, decimal cityDamage, decimal firstMoveAt) { Hp = hp; Attack = attack; AttackInterval = attackInterval; CityDamage = cityDamage; FirstMoveAt = firstMoveAt; } public decimal Hp { get; private set; } public decimal Attack { get; private set; } public decimal AttackInterval { get; private set; } public decimal CityDamage { get; private set; } public decimal FirstMoveAt { get; private set; } }
